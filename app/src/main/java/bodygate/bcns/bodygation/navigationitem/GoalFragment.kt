...
class GoalFragment : Fragment(), CompoundButton.OnCheckedChangeListener {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        goal_height_txtB.setOnEditorActionListener(object :TextView.OnEditorActionListener{
            override fun onEditorAction(p0: TextView?, p1: Int, p2: KeyEvent?): Boolean {
                if(p0!!.text.isNotEmpty() && p1 == Keyboard.KEYCODE_DONE){
                    my_weight_txtB.setFocusable(true)
                    return true
                }
                return false
        ...
        my_weight_txtB.setOnFocusChangeListener(object :View.OnFocusChangeListener{
            override fun onFocusChange(v: View?, hasFocus: Boolean) {
                if(hasFocus) {
                    ...
                    if (goal_height_txtB.text.isNotEmpty() && goal_weight_txtB.text.isNotEmpty() && my_weight_txtB.text.isNotEmpty()) {
        ...
        my_weight_txtB.setOnEditorActionListener(object :TextView.OnEditorActionListener{
            override fun onEditorAction(p0: TextView?, p1: Int, p2: KeyEvent?): Boolean {
                if(p0!!.text.isNotEmpty() && p1 == Keyboard.KEYCODE_DONE){
                    my_musclemass_txtB.setFocusable(true)
                    return true
        ...
        my_musclemass_txtB.setOnEditorActionListener(object :TextView.OnEditorActionListener{
            override fun onEditorAction(p0: TextView?, p1: Int, p2: KeyEvent?): Boolean {
                if(p0!!.text.isNotEmpty() && p1 == Keyboard.KEYCODE_DONE){
                    my_bodyfat_txtB.setFocusable(true)
                    return true
        ...
        my_bodyfat_txtB.setOnEditorActionListener(object :TextView.OnEditorActionListener{
            override fun onEditorAction(p0: TextView?, p1: Int, p2: KeyEvent?): Boolean {
                if(p0!!.text.isNotEmpty() && p1 == Keyboard.KEYCODE_DONE){
                    my_bodyfat_txtB.setFocusable(false)
                    return true
